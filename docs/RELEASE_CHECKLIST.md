...
5. Confirm the Blueprint has these production security variables:
   ...
   - CMS service `phoamthuc-cms`: `CMS_ADMIN_PASSWORD` is generated by Render.
6. Reveal/copy the generated `CMS_ADMIN_PASSWORD` from Render and store it in your password manager.
...
9. Open the CMS URL and confirm protected pages redirect to `/Login`; sign in with `admin` and the generated password.
