...
| --- | --- | --- | --- | --- | --- |
| F01 | Khoi dong, kich hoat quyen su dung app va mo khoa subscription gate | Khach du lich | `LaunchPage.RouteAsync()`, `SubscriptionState.IsSubscriptionActive()`, `MainPage.EnsureSubscriptionGateAsync()`, `RestoreSubscriptionStateAsync()`, `SubscriptionPage.OnMuaGoiClicked()`, `ActivateFreeTrialAsync()` | `VinhKhanhTourDemo/LaunchPage.xaml.cs`, `SubscriptionState.cs`, `DeviceIdentity.cs`, `MainPage.xaml.cs`, `SubscriptionPage.xaml.cs`, `VinhKhanhTour.API/Controllers/SubscriptionController.cs` | `00-overall-usecase.puml`, `01-subscription-gate-activity.puml`, `01-subscription-gate-sequence.puml` |
| F02 | Tai, kham pha danh sach POI va dong bo lich su/XP | Khach du lich | `LoadPoisFromApi()`, `RestorePoiHistoryAsync()`, `SyncPoiHistoryAsync()`, `RefreshPoisInBackgroundAsync()`, `RenderPoiCards()`, `OnSearchTextChanged()`, `OpenPoiDetailAsync()` | `VinhKhanhTourDemo/MainPage.xaml.cs`, `DeviceIdentity.cs`, `VinhKhanhTour.API/Controllers/PoiController.cs`, `VinhKhanhTour.API/Controllers/HeartbeatController.cs` | `02-poi-explore-activity.puml`, `02-poi-explore-sequence.puml` |
